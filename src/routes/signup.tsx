...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      { title: "Create account — WrenchRate" },
      { name: "description", content: "Join WrenchRate to share your mechanic experiences." },
    ],
  }),
...
const schema = z.object({
  displayName: z.string().trim().min(2, "Name too short").max(50, "Name too long"),
  ...
  return (
    <main className="container mx-auto max-w-md px-4 py-12">
      ...
      <p className="mt-2 text-muted-foreground">
        Help fellow drivers find good mechanics — and steer clear of bad ones.
      </p>
